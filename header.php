    ...
    <div class="navbar-inner">
        <div class="container-fluid">
            ...
            <a class="brand" href="index.php">
                <img src="assets/img/EmpSenseSmallLogo.png" alt="logo" />
            </a>
            <!-- END LOGO -->
                ...
                <li class="dropdown" id="header_task_bar">
                    ...
                    <span class="badge">
                        <?php
                            ...
                            $sqlToGetEmployeeChurn = "SELECT count(*) as 'NumOfEmployees' FROM `employeesit_predict` where probability>0.9 and probability <> 1.0"; 
                                ...
                                <ul class="dropdown-menu-list scroller"  style="height:250px">                                    
                                    <li>
                                        <?php
                                            ...
                                            //get distinct Doctor Details
                                            $sqlToGetEmployeeChurn = "SELECT Employee_Name,probability,Gender FROM `employeesit_predict` where probability>0.9 and probability <> 1.0"; 
                                            $result = mysqli_query($con,$sqlToGetEmployeeChurn);
